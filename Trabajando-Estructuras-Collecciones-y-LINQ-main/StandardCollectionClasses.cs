...
namespace StandardCollectionClasses
{
    class Program
    {
        ...
        //puedes meter un tipo en  una posicion, otro tipo en otra y una esctructura en otra... . Es muy costosa para la memoria
        public void ArrayListCollection()
        {
            ...
            Coffee coffee4 = new Coffee(4, "Robusta", "España");
            ...
            Console.WriteLine(coffee4.Bean);//accedemos directamente a la vriable cofee4
           ...
           // }
            ...
            foreach (dynamic coffee in beverages)
            {
                if (typeof(Coffee) == coffee.GetType()){
                    ...
                    Console.WriteLine("Country of origin: {0}", coffee.CountryOfOrigin);
                    Console.WriteLine("Strength (1-5): {0}", coffee.Strength);
                }else if(typeof(TempRecord) == coffee.GetType()){
                    Console.WriteLine(coffee.City);
                }else{
        ...
        public void HashTableCollection()
        {
            ...
            {
                Console.WriteLine("CONTAINSKEY - Café Mocha ");
                // Retrieve the value associated with a key.
                Console.WriteLine("The ingredients of a Café Mocha are: {0}", ingredients[idKey]);
            }
             Console.WriteLine("DIRECTAMENTE - Cappuccino");
             Console.WriteLine("The ingredients of a Cappuccino: {0}",ingredients["Cappuccino"]);
            ...
            Console.WriteLine("Los que tienen Milk: ");
