...
namespace Streams
{
    class UsingBinaryReader
    {
        ...
        {
            // Source file path.
            string sourceFilePath = @"E:\JUANJO\CURSO2020\MODULO2_CSHARP\Stream-en-CSharp-master\ficheros\settings.txt ";
        ...
        {
            string destinationFilePath = @"E:\JUANJO\CURSO2020\MODULO2_CSHARP\Stream-en-CSharp-master\ficheros\settings.txt";
            // Collection of bytes.
