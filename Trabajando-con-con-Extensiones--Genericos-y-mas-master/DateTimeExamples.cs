...
namespace Extending06
{
    ...
    public class UsingDateTime
    {
        ...
        public void UsingDateTimes()
        {
            ...
            Thread.CurrentThread.CurrentCulture = myCultureInfo;//Tenemos que cambiar el Thread para que a partir
                                                                //de ahora cambie la cultura
            string mySpanishDate = "23 Diciembre 2018";
