...
namespace AzureStorageDemo.Controllers
{
    public class BlobController : Controller
    {
        ...
        public BlobController(IConfiguration configuration, PhotoContext dbContext)
        {
            ...
            _connectionString = _configuration.GetConnectionString("AzureStorageConnectionStrings-1");
        }
        ...
        public async Task UploadAsync(IFormFile photo)
        {
            ...
            CloudBlobContainer container = blobClient.GetContainerReference("miprimercontenedor");
